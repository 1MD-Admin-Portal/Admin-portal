...
const mockReports = [
  ...
  },
  {
    ...
    reportedBy: "mahi@dancer.com",
    dateRaised: "2025-07-15",
    against: "Subscription Service",
...
const ReportManagement = () => {
  ...
  return (
    <div className="report-management-container">
      <h2 className="report-management-title">Report IT Management</h2>
              ...
              <tr key={report.id}>
                ...
                <td className="actions-cell" ref={dropdownRef}>
                  ...
                  {openMenuId === report.id && (
                    <div
                      className={`dropdown-menu ${isLastTwo ? "open-up" : ""}`}
                    >
                      <div onClick={() => handleAction("Flag", report.id)}>
                        ⚠️ Flag
                      </div>
                      <div onClick={() => handleAction("Suspend", report.id)}>
                        ⛔ Suspend
                      </div>
                      <div onClick={() => handleAction("Delete", report.id)}>
                        ❌ Delete
                      </div>
                    </div>
                  )}
