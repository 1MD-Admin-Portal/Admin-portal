...
const ClassModeration = () => {
  ...
  const handleApprove = (index) => {
    alert(`Approved: ${filteredClasses[index].title}`);
    setOpenDropdownIndex(null);
  };

  const handleReject = (index) => {
    alert(`Rejected: ${filteredClasses[index].title}`);
    setOpenDropdownIndex(null);
  };

  const classesToShow = tab === "ongoing" ? ongoingClasses : upcomingClasses;
      ...
      {selectedClass && (
        ...
        >
          ...
          >
            ...
            <p>
              <strong>Slots/Day:</strong> {selectedClass.slots}
            </p>
            <p>
