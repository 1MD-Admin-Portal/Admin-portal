...
const DancersPage = () => {
  ...
  return (
    <div className="dancers-container">
      ...
      {openModal === 'detail' && <DancerDetailModal dancer={selectedDancer} onClose={closeModal} />}
      {openModal === 'edit' && <EditModal dancer={selectedDancer} onClose={closeModal} />}
      {openModal === 'calendar' && <CalendarModal dancer={selectedDancer} onClose={closeModal} />}
      {openModal === 'preferences' && <PreferenceModal dancer={selectedDancer} onClose={closeModal} />}
      {openModal === 'reset' && <ResetPasswordModal dancer={selectedDancer} onClose={closeModal} />}
    </div>
  );
};
