...
//           <h1 className="text-white fw-bold display-4 mb-2">
...
//                             </div>
//                             <div className="d-flex align-items-center">
//                               <Upload size={16} className="me-1 text-primary" />
//                               <small>
...
//                 <h2 className="card-title mb-0">Pending Submissions</h2>
//               </div>
//               <div className="card-body">
//                 {loading ? (
//                   <div className="d-flex justify-content-center py-5">
...
//                     />
//                     <label className="form-check-label">Mark as Trending</label>
//                   </div>
...
//                           <span>{selectedChallenge.challenge.dance_style}</span>
//                         </div>
//                         <div className="d-flex align-items-center mb-2">
//                           <TrendingUp size={18} className="me-2 text-primary" />
//                           <span>{selectedChallenge.challenge.dance_level}</span>
//                         </div>
//                         {selectedChallenge.challenge.prize_details && (
//                           <div className="d-flex align-items-center mb-2">
//                             <Award size={18} className="me-2 text-primary" />
//                             <span>{selectedChallenge.challenge.prize_details}</span>
//                           </div>
//                         )}
//                         <div className="d-flex align-items-center mb-2">
...
//                           <span>
//                             Max:{" "}
//                             {selectedChallenge.challenge.max_participants || "Unlimited"}{" "}
//                             participants
//                           </span>
//                         </div>
//                       </div>
...
//                               <h4>
//                                 {selectedChallenge.challenge.participants_count || 0}
//                               </h4>
...
//                               <h4>
//                                 {selectedChallenge.challenge.submissions_count || 0}
//                               </h4>
...
//                               <h4>
//                                 {selectedChallenge.challenge.pending_submissions || 0}
//                               </h4>
...
//                                 {analytics.analytics.approved_submissions || 0}
//                               </div>
...
//                       <p className="mb-1">by {selectedSubmission.username}</p>
...
//                       <div className="d-flex align-items-center">
//                         <ThumbsUp size={16} className="me-1 text-muted" />
