      ...
      {selectedFeed && (
        ...
        >
          ...
          >
            ...
            <button onClick={() => handleViewLikes(selectedFeed.post_id)}>
              View Likes
            </button>
        ...
        <div className="modal-overlay-likes" onClick={() => setLikesData(null)}>
          ...
          >
            ...
            <ul>
              {likesData.likes.map((like) => (
                <li key={like.like_id}>
                  ...
                  />
                  {like.user.name} ({like.user.skill_level})
                </li>
              ))}
            </ul>
            ...
            <p>
              ...
              {likesData.analytics.engagement_insights.most_active_skill_level}
            </p>
            <p>
              Peak Like Date:{" "}
