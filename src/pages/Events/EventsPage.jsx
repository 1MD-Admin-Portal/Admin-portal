...
const EventsPage = () => {
  ...
  const openEventModal = async (event) => {
    ...
    // If approved tab, fetch interested users automatically
  ...
  return (
    <div className="event-moderation-wrapper">
      <div className="event-moderation-header">
        <h1 className="event-moderation-title">Event Moderation</h1>
        <p className="event-moderation-subtitle">
          Manage and review event submissions
        </p>
      </div>
          ...
          <table className="event-moderation-table">
            ...
            <thead>
              <tr>
                ...
                <th>Created at</th>
                {/* ✅ Only show Actions column for requireApproval tab */}
                {activeTab === "requireApproval" && <th>Actions</th>}
              </tr>
            </thead>
            <tbody>
              {events.map((event) => (
                <tr
                  key={event.event_id}
                  className="event-table-row clickable"
                  onClick={() => openEventModal(event)}
                >
                  <td className="event-title-column">
                    <div className="event-title-wrapper">
                      <span className="event-title-label">
                        {event.event_title}
                      </span>
                  ...
                  <td className="event-type-column">
                    <div className="event-type-badges">
                      <span
                        className={`event-type-badge event-type-${event.event_type?.toLowerCase().replace(" ", "-")}`}
                      >
                        {event.event_type}
                      </span>
                      {event.dance_style && (
                        <span
                          className={`event-dance-badge event-dance-${event.dance_style?.toLowerCase().replace(" ", "-")}`}
                        >
                          {event.dance_style}
                        </span>
                      )}
                  ...
                  {/* ✅ Only show approve/reject actions for requireApproval tab */}
                  {activeTab === "requireApproval" && (
                    <td className="event-actions-column">
                      <div className="event-action-buttons">
                        <button
          ...
          >
            ...
            <div className="event-modal-content">
              <div className="event-modal-grid">
                  ...
                  <div className="event-info-section">
                    ...
                    <div className="event-info-cards">
                      <div className="event-info-card">
                        ...
                        <div className="event-info-value">
                          <span
                            className={`event-type-badge event-type-${selectedEvent.event_type?.toLowerCase().replace(" ", "-")}`}
                          >
                            {selectedEvent.event_type}
                          </span>
                        </div>
                      ...
                      <div className="event-info-card">
                        ...
                        <div className="event-info-value">
                          <span
                            className={`event-dance-badge event-dance-${selectedEvent.dance_style?.toLowerCase().replace(" ", "-")}`}
                          >
                            {selectedEvent.dance_style}
                          </span>
                        </div>
                ...
                {/* Right Column - Images & Interested Users */}
                <div className="event-modal-right">
                  {selectedEvent.images && (
                    <div className="event-images-section">
                      <h3 className="event-section-title">
                  ...
                  {/* ✅ Interested Users - shown only in approved tab */}
                  {activeTab === "approved" && (
                    <div className="event-users-section">
                      <h3 className="event-section-title">
                        <Users size={20} />
                      ...
                      {interestedLoading ? (
                        <div className="event-users-loading">
                          Loading interested users...
                        </div>
                      ) : interestedUsers.length === 0 ? (
                        <div className="event-users-empty">
